...
3.  **Hero Section**
    *   Displays "Hello, I'm" with the editable name (Vikram Deshpande) and reveal animation.
    *   Displays subtitle highlighting Senior Technical Manager & AI Solution Architect.
    *   Contains functional links to GitHub, YouTube, Resume PDF, and a "Let's Talk" (Contact) anchor.
...
6.  **Work Section**
    ...
    *   Displays "Current Project in the Pipeline" title.
    *   Contains project cards (e.g., "GitHub: VicsGitRepos").

7.  **Contact Section**
    *   Section exists with ID `contact`.
    *   Displays CTA "Let’s ship AI/ML programs that stay fast, safe, and compliant.".
    *   Contains a `mailto` link for `melbvicduque@gmail.com`.
    *   Contains social media links (GitHub, YouTube).
...
8.  **Visual Design & Interactivity**
    ...
    *   Fonts `Roboto`, `Roboto Condensed`, and `Source Sans Pro` are used.
