 ...
 * that measured cold walk — 2 600 ms, the 2 449 ms worst observed cold first
 * token plus a small margin — and the budget is cancelled the instant the
 * response headers land, which for this function means the instant the first
 ...
 */
export const DIRECT_FIRST_BYTE_TIMEOUT_MS = 2600;
