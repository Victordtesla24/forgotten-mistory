...
## COMPLETE (2026-09-06T05:00:37.900Z)
ap-w2-r3a2: 3ba8ed97 + 07be6ef4 pushed (live fda84067 + next tick). Greeting regenerated WITH its alignment in one /with-timestamps call (381 chars, mp3 421,764 B, sha256 2eb7788f…, 26.285 s; schedule 244 cues, min 0.046 s, 16 distinct visemes; three-way digest pin; VS-01..08 + envelope digest green; 11 node tests; tsc/lint/build/audit 10/10; ledger). §0.1 decision recorded: the configured ELEVENLABS_VOICE_ID is a CLONED voice and the API refused (401 ivc_not_permitted, 0 characters spent) — the premade Australian male 'Charlie' (IKne3meq5aSn9XLyUdCD) was used; 1 TTS call spent, no IVC. Consequence: greeting voice ≠ live reply voice (George via the function's secret) → voice consistency folded into t_w2_r3a4. Chatbot e2e reds TC-BOT-12/14 were the pre-mv4 panel geometry (fixed in fda84067).
