...
## COMPLETE (2026-09-06T04:38:48.204Z)
ap-w1-mv3 (over cap): 50b7ed9e pushed and consolidated. Decision (b) applied to BOTH the spec-named node (Vitrine .exclusion dd) and the node that actually fails on b9f5195 (Skills .caveat at scrollY 14348, 4.00:1) — --ink-300 → --mist-400: 5.22:1 / 5.16:1 on the launcher hairline ground, 6.20:1 on page ground; TC-MV-OCCLUDE-01 0/13 nodes below AA; visual baselines re-accepted with reason; launcher CSS untouched; Hero untouched. MONO-MV-02: root cause = TEST (fade-in wait; label paints at the loop's first read, data-past-hero=true) — the earlier IntersectionObserver hypothesis did not reproduce on b9f5195; both widths now green. NEW regression found (outside scope by instruction): TC-MV-OCCLUDE-02 @390 — the closed launcher paints rgb(174,174,174) (L 0.4233 vs 0.0968 ceiling), regressed between b02a8863 and b9f5195e in another lane → t_w1_mv5.
