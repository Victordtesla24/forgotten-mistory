export const resumeContent = {
  ...
  "Leadership Scale": {
    ...
    details: [
      ...
      "Managed program portfolio valued at over $5M.",
      "Conducted exec workshops improving decision clarity by ~55%."
    ]
  },
  "Strategic Alignment": {
    ...
    details: [
      ...
      "Stakeholder alignment across technical and business domains.",
      "Ensuring AI/ML pilots land in production with tangible business value."
    ]
  },
  "Portfolio Value": {
    ...
    details: [
      ...
      "Delivered analytics and BI projects boosting client engagement.",
